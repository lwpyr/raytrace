...
int main(int argc, char* argv[]){
    ...
    PointLightSource *light2 = new PointLightSource(Vector3(-8,19.999,5),Color3(8));
    light2->setHost(circle1);
    PointLightSource *light4 = new PointLightSource(Vector3(-8,19.999,5.3),Color3(8));
    light4->setHost(circle1);
    PointLightSource *light5 = new PointLightSource(Vector3(-8,19.999,4.7),Color3(8));
    light5->setHost(circle1);
    PointLightSource *light6 = new PointLightSource(Vector3(-8.3,19.999,5),Color3(8));
    light6->setHost(circle1);
    PointLightSource *light7 = new PointLightSource(Vector3(-7.7,19.999,5),Color3(8));
    light7->setHost(circle1);
    PointLightSource *light8 = new PointLightSource(Vector3(-8.3,19.999,5.3),Color3(8));
    light8->setHost(circle1);
    PointLightSource *light9 = new PointLightSource(Vector3(-8.3,19.999,4.7),Color3(8));
    light9->setHost(circle1);
    PointLightSource *light10 = new PointLightSource(Vector3(-7.7,19.999,5.3),Color3(8));
    light10->setHost(circle1);
    PointLightSource *light11 = new PointLightSource(Vector3(-7.7,19.999,4.7),Color3(8));
    ...
    // transparent
    Phong *material8 = new Phong(Color3(0.3), Color3(1), 256, 3, 1);
    ...
    material9->trace_reflectivity = 0.15;
